...
const HeroSlider = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      subheading: "Accelerate your revenue cycle with our streamlined processes. Get paid faster with our AI-powered claims processing that identifies and resolves issues before submission.",
